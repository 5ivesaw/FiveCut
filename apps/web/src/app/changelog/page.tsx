...
export const metadata: Metadata = {
	title: "Changelog - FiveCut",
	description: "What's new in FiveCut",
	openGraph: {
		title: "Changelog - FiveCut",
		description: "Every update, improvement, and fix to FiveCut — documented.",
		type: "website",
		images: [
			{
...
export default function ChangelogPage() {
	...
	return (
		<BasePage title="Changelog" description="See what's new in FiveCut">
