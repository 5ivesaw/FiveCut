...
export const metadata: Metadata = {
	title: "Terms of Service - FiveCut",
	description:
		"FiveCut's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
	openGraph: {
		title: "Terms of Service - FiveCut",
		description:
			"FiveCut's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
		...
		>
			...
			<section className="flex flex-col gap-3">
				...
				<ul className="list-disc space-y-2 pl-6">
					...
					<li>No watermarks, no licensing restrictions from FiveCut</li>
				</ul>
			</section>

			<section className="flex flex-col gap-3">
				<h2 className="text-2xl font-semibold">How You Can Use FiveCut</h2>
				<p>FiveCut is free for personal and commercial use. You can:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
						Create videos for personal, educational, or commercial purposes
					</li>
					<li>Use FiveCut for client work and paid projects</li>
					<li>Share and distribute videos created with FiveCut</li>
					<li>
						Modify and distribute the FiveCut software (under MIT license)
					</li>
				</ul>
				<p>
					You're responsible for how you use FiveCut and the content you create.
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					...
					are optional - you can use FiveCut without them.
				</p>
			</section>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					FiveCut does not currently require an account. The service is provided
			...
			<section className="flex flex-col gap-3">
				...
				<p>Because FiveCut is open source, you have additional rights:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>Review our code to see exactly how we handle your data</li>
					<li>Self-host FiveCut on your own servers</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					FiveCut is provided free of charge. To the extent permitted by law:
				</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>We may update FiveCut and these terms:</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>You can stop using FiveCut at any time:</p>
				<ul className="list-disc space-y-2 pl-6">
