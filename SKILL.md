...
Read
[project-format.md](skills/fivecut-editor-agent/references/project-format.md)
when creating or editing project JSON. Read
[professional-workflow.md](skills/fivecut-editor-agent/references/professional-workflow.md)
